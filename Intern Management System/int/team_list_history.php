                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table  class="table table-bordered table-striped table-hover dataTable team-list-history">
                                <thead>
...
<script type="text/javascript">
    $(function () {
        var table =  $('.team-list-history').DataTable({
            ajax: "batch_logics.php?&dtShowAllTeamsOfUser="+"team_lists",
            columns: [
                { "data": "team_name" },
                { "data": "num_members" },
                { "data": "num_projects" },
        ...
        $('.team-list-history tbody').on('click', 'tr', function () {
