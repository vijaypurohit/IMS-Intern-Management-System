...
<!--                                <div class="form-group">-->
                                <div class="form-group" style="text-align: center; padding-left: 25px">
                                    <?php global $profPicName; global $lastUpdateNumDaysMonths; global $format_lastUpdateTime;?>
                                        <img class="image-area" src="<?php echo UPLOAD_URL.$upload_profile_fol_name.$profPicName; ?>" id="profile_img" style="height: 150px; width:150px; border-radius: 50%;" alt="<?php echo $user['username']; ?>" data-toggle="tooltip" data-placement="bottom" title="1. Click on this Picture to Select a New One">
                                ...
                                <div role="tabpanel" class="tab-pane fade in" id="change_user_signature">
                                    <form id="update_user_sign" action="my_profile.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group" style="text-align: center; padding-left: 25px">
                                            ...
                                            <img class="image-area" src="<?php echo UPLOAD_URL.$upload_profile_fol_name.$userSignName; ?>" id="user-sign-img" style="height: 50%; width:50%;" alt="<?php echo $user['username']."-sign"; ?>" data-toggle="tooltip" data-placement="bottom" title="1. Click on this Picture to Select a New One">
                                            <!-- hidden file input to trigger with JQuery  -->
