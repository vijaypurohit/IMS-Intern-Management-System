...
<aside id="leftsidebar" class="sidebar">
        ...
        <div class="info-container">
            ...
            <div class="btn-group user-helper-dropdown">
                ...
                <ul class="dropdown-menu pull-right">
                    <li><a href="<?php echo $int_pages_link ?>my_profile.php"><i class="material-icons">person</i>Profile Settings</a></li>
                    <!--                    <li><a href="javascript:void(0);"><i class="material-icons">group</i>Followers</a></li>-->
                    <!--                    <li><a href="javascript:void(0);"><i class="material-icons">shopping_cart</i>Sales</a></li>-->
                    <!--                    <li><a href="javascript:void(0);"><i class="material-icons">favorite</i>Likes</a></li>-->
                    <li role="separator" class="divider"></li>
                    <li><a href="<?php echo $int_pages_link ?>_logout.php"><i class="material-icons">input</i>Sign Out</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active">
                <a href="<?php echo $int_pages_link ?>index.php">
            ...
            <!--PROFILE-->
<!--            <li >-->
<!--                <a href="--><?php //echo $int_pages_link.$user_folder_name ?><!--user_profile_view.php">-->
...
<!--            </li>-->
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="<?php echo $int_pages_link.$batch_folder_name ?>batch_ongoing_batches.php">
                            <span data-toggle="tooltip" data-placement="right" title="list of current batches">Current Batch</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $int_pages_link.$batch_folder_name ?>batches_list_history.php">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="<?php echo $int_pages_link ?>team_ongoing.php">
                            <span data-toggle="tooltip" data-placement="right" title="list of current teams">Current Teams</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $int_pages_link ?>team_list_history.php">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="<?php echo $int_pages_link ?>project_ongoing.php">
                            <span data-toggle="tooltip" data-placement="right" title="list of current projects">Current Projects</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $int_pages_link ?>projects_list_history.php">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    ...
                    <li>
                        <a href="<?php echo $int_pages_link ?>tasks_ongoing_user.php">
                            <span  data-toggle="tooltip" data-placement="right" title="view all the pending tasks" >Pending</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $int_pages_link ?>tasks_list_history.php">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="<?php echo $int_pages_link.$batch_folder_name ?>batch_attendance_report.php">
                            <span data-toggle="tooltip" data-placement="right" title="show attendance report">Current Report</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $int_pages_link.$batch_folder_name ?>batch_attendance_report_past.php">
                            <span data-toggle="tooltip" data-placement="right" title="show attendance report of your previous batch">Past Report</span>
                        </a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="<?php echo $int_pages_link.$batch_folder_name ?>intern_leaves.php">
                            <span data-toggle="tooltip" data-placement="right" title="initiate leave">Initiate</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo $int_pages_link.$batch_folder_name ?>leave_history.php">
