                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table  class="table table-bordered table-striped table-hover dataTable batch-list-history">
                                <thead>
...
<script type="text/javascript">
    $(function () {
        var table =  $('.batch-list-history').DataTable({
            ajax: "batch_logics.php?&dtShowAllBatchesOfUser="+"batch_list",
            columns: [
                { "data": "batch_name" },
                { "data": "number_of_interns" },
                { "data": "duration" },
                { "data": "created_at" },
            ...
            buttons: [
                'copy', 'csv', 'excel',
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1').text('<?php echo APP_TITLE ?> - Batches');
                        $(win.document.body)
                            .css( 'font-size', '12pt' )
                            .prepend(
        ...
        // $('.batch-list-history tbody').on('click', 'tr', function () {
