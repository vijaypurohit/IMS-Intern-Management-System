        ...
        <div class="row clearfix">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12 col-md-12">
                                        <select id="project_s_option" name="project_s_option" class="form-control show-tick" required>
                                            <option value=''>CHANGE STATUS </option>;
                                            <option value="<?php echo pj_dismissed ?>">Dismissed</option>;
                                            <option value="<?php echo pj_completed ?>">Completed</option>;
                                        </select>
                                    </div>
                                </div>
                                    <div class="m-t-25 m-b--5 align-center">
                                        <button class="btn btn-block  bg-deep-purple waves-effect" name="project_status_submit" id="project_status_submit" type="submit">SUBMIT</button>
                                    </div>
                                </form>
                                <?php
                                endif;
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" >
                <div class="card " >
                    ...
                    <div class="body" style="overflow-y: scroll; height: 350px">
                        <div class="row clearfix">
                            <div class="col-md-12" >
