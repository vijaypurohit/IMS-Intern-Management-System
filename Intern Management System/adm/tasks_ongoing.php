        ...
        <div class="container-fluid" style="padding-top: 25px">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="help-block">red title name - notification not seen,  green title name - notification seen</div>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var table =  $('.show-all-task').DataTable({
            ajax: "task_logics.php?&dtShowAllTasksPending="+"Pending&selectedYear="+ <?php echo $date_year_check?>,
            columns: [
                { "data": "tk_title" },
                { "data": "intern_name" },
                { "data": "tk_project" },
            ...
            order: [[0, 'asc'],[2, 'asc']],
            rowGroup: {
                dataSrc: 'intern_name'                 // row grouping based on column
            },
