...
$from_url_path = 'admin';
$subTitle = 'ADMIN '.base64_decode('WyB2aWpheWNoaXR0aSBda');
...
<!-- Top Bar -->
<?php  require_once (ADM_PATH .'/_navbar.php'); ?>
<!-- #Top Bar -->
<section>
    <!-- Left Sidebar -->
    <?php  require_once (ADM_PATH .'/_sidebar.php'); ?>
    <!-- #END# Left Sidebar -->

    <!-- Right Sidebar -->
<!--    --><?php // require_once (ADM_PATH .'/_rSidebar.php'); ?>
    <!-- #END# Right Sidebar -->
</section>
