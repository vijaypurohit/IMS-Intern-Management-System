...
//$arr_data= $_REQUEST['tkid'];
//$tsk = unserialize(urldecode($arr_data));
...
$notify_string = $tsk['notify'] == tsk_inspection ? 'NOT SEEN by User' : ($tsk['notify'] == tsk_inspectionViewed ? 'SEEN by User' :'NOT SEND' );
$notify_string_color = $tsk['notify'] == tsk_inspection ? '#ffc107' : ($tsk['notify'] == tsk_inspectionViewed ? '#4caf50' : '#ff0707');
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <select id="task_s_option" name="task_s_option" class="form-control show-tick" required>
                                                        ...
                                                        <option value="<?php echo tsk_completed ?>">Completed</option>;
                                                    </select>
                                                </div>
                                            </div>
